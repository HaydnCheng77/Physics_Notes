...
\onefig{integralcurves}{scale=0.4} 
...
\onefig{integralcurves2}{scale=0.5} 
...
\example{Exact Differential and Integrating Factor.}
{Solve
...
\example{Introduction of Parameter (1).}
{Solve
...
\example{Introduction of Parameter (2).}
{Solve 
...
\example{Non-Diagonalizable System.}
...
\example{Second Order Vector Differential Equation.}

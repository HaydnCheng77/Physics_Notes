...
\example{Terrell–Penrose Rotation.}
...
\twofig{topview}{width=\textwidth}{rotatedsquare}{width=\textwidth}{topviewrotatedsquare} 

\onefig{twin}{scale=0.2} 
...
\onefig{wrong}{scale=0.3} 

\example{Superluminal Motion.}

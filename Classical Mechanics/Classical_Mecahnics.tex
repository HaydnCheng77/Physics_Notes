...
The sketches for \(k = 2, 7 \text { and } 7/4\) can be found in \cref{efforbits1} and \cref{efforbits2}. \Cref{2eff} and \cref{2eff1} shows the case for \(k = 2\), where the amplitude of the raidal disturbation is set to be \(0.1r_0 \text { and } 0.3r_0 \) respectively, while \cref{7eff} and \cref{74eff} show the case for \(k=7 \text { and } 7/4\) respectively. Note that for small enough amplitude of raidal oscilaltion and for \(k =2\) the orbit is an ellipse, as expected. 
} 

\twofig{2eff}{width=\textwidth}{2eff1}{width=\textwidth}{efforbits1} 

\twofig{7eff}{width=\textwidth}{74eff}{width=\textwidth}{efforbits2} 

\example{Power Laws (2).}
